...
<form action="Mailto:vedantjohari15@gmal.com">
    ...
    <br /><br />
    <label for="id1">
        <input type="radio" value="Graduate" name="class" id="id1">Graduate
    </label>
    <label for="id2">
        <input type="radio" value="Undergraduate" name="class" id="id2">UnderGraduate
    </label>
    <label for="id3">
        <input type="radio" value="School" name="class" id="id3">School
    </label>
    <br /><br />
    Select Your City
    ...
    <br /><br />
    <input type="text" placeholder="tell us your Story, about yourself">
    <br /><br />
    <textarea name="feedback" id="feedback" placeholder="please give your humble feedback" rows=5></textarea>
    <br /><br />
    <input type="submit" value="submit">
</form>
<br /><br />
<iframe width="560" height="315" src="https://www.youtube.com/embed/OWrnt6VOkKY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<iframe width="560" height="315" src="https://en.wikipedia.org/wiki/India"></iframe>
<br /><br />
<footer><h5>Contect me at vedantjohari15@gmail.com</h5><h5>Phone Number - 9821004773</h5></footer>
</body>
</html>
